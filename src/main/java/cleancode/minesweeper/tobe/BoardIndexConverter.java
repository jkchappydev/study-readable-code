...
public class BoardIndexConverter {
    ...
    public int getSelectedColIndex(String cellInput, int colSize) {
        ...
        return convertColFrom(cellInputCol, colSize); // From ~~ cellInputCol 처럼 자연스럽게 읽힌다.
    }

    private int convertRowFrom(String cellInputRow, int rowSize) { // '10'이 들어옴
    ...
    private int convertColFrom(char cellInputCol, int colSize) { // 'a'가 들어옴
        // ascii code 연산
